package com.agentx.campus.security;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/api/v1/auth/**", "/api/v1/health", "/actuator/**", "/api/v1/notifications/stream").permitAll()
                .requestMatchers(HttpMethod.OPTIONS, "/**").permitAll()
                // Task 8: Swagger UI public access
                .requestMatchers("/swagger-ui/**", "/swagger-ui.html", "/v3/api-docs/**", "/v3/api-docs").permitAll()
                .requestMatchers("/api/v1/student/**").hasAnyRole("STUDENT", "ADMIN")
                .requestMatchers("/api/v1/faculty/**").hasRole("FACULTY")
                .requestMatchers("/api/v1/hod/**").hasAnyRole("HOD", "ADMIN")
